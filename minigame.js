		...
		loadAsync() {
			return c(this, void 0, void 0, function* () {
				...
				try {
					...
					var t;
					throw console.info("Loading Failed: " + this.getInfo(), e), e.code === J ? (console.info("Ads Not Fill, stop loading: " + this.getInfo()), this.setFatalError()) : (this.increaseErrorCounter(), this._state = a.NEW, t = 10 * this._errorCounter + 1, console.log("Reload after " + t + " seconds: " + this.getInfo()), this.safeRe
						(t)), e
				}
			})
		}
...
digest: ` + r, "HMACSHA512-SecretKey")),
	...
	var li = {
		...
		initializeAsync: function (a) {
			return c(this, void 0, void 0, function* () {				
				console.log("cai con cac nay la gi?" + this.inited);
				...
				try {
					console.log("oke h chay vao day")
